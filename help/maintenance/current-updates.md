...
**“[!UICONTROL コメントを投稿できません]返信時の「メッセージ**
...
**からリクエストを作成する際にドキュメントが添付されない[!DNL Outlook]**
...
新しいコメント機能でユーザーがコメントを表示しようとすると、コメントが表示されず、代わりに次のエラーが表示されます。

「異常が発生しました。 後でもう一度試してください。」

従来のコメント機能が期待どおりに動作します。
...
### Workfront Fusion の 2024 年 3 月 28 日のメンテナンス更新

**Workfront モジュールからの 200 応答を持つ RuntimeError**
