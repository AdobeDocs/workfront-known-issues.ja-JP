...
+++**（予定）2024年4月4日（PT）のメンテナンス更新**

### （予定）2024年4月4日（PT）のメンテナンス更新

#### 時間のログ記録

**ユーザーは現在の日の時刻をログに記録できません**
...
新しいコメント作成エクスペリエンスでコメントを表示しようとすると、コメントは表示されず、代わりに次のエラーが表示されます。

「何か問題が発生しました。 後で再度お試しください。」

従来のコメントエクスペリエンスは期待どおりに動作します。
...
### Workfront Fusion メンテナンスアップデート（2024 年 3 月 29 日）

**Workfrontモジュールからの 200 応答を含む RuntimeError**
