...
+++**（予定）2024年2月8日のメンテナンス更新**

### （計画済み）2024 年 2 月 8 日のメンテナンス更新

#### ボード

**次を使用して列内のカードを移動することはできません： [!UICONTROL 移動] options**
...
グラフレポートに[!DNL No value]」列には、データが存在する場合でも、データが表示されません。

+++

+++**2024年2月1日（PT）のメンテナンス更新**

### 2024 年 2 月 2 日のメンテナンス更新
