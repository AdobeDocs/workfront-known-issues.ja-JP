...
**ダッシュボードレポートで並べ替えに使用すると、列が消える**

ダッシュボード内に配置されたレポートを列で並べ替える場合、列は非表示になり、コンテンツは並べ替えられません。

#### レポート

**グラフオプションの下のグループ列が原因でエラーが発生する**

グラフ付きレポートで「グラフの下に列をグループ化」オプションを有効にすると、「エラーが発生し、問題の解決に取り組んでいます。 作業を続行するには、このブラウザーページを更新してみてください。」が表示されます。

**レポートに表示されない一括編集アイコンと一括削除アイコン**

複数の報告書項目を一括で編集または削除しようとすると、「編集」アイコンと「削除」アイコンが表示されないことがあります。
