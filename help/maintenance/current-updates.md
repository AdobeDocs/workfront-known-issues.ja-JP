...
### 2024 年 7 月 25 日のメンテナンス更新

#### カスタムフォーム

**複数の値を選択するとドロップダウンが閉じる**
...
### 2024 年 7 月 11 日のメンテナンス更新

#### イシュー

**問題に高度な割り当てを行う際にエラーが発生する**
...
**時間レポートでマトリックス設定を設定中にエラーが発生する**

ユーザーが時間報告書でマトリックス設定を設定しようとすると、設定を設定できず、次のエラーが表示されます。
...
### 2024 年 7 月 4 日のメンテナンス更新

#### ホーム

**3 つのドットメニューは無効**

従来のホームワークリストでユーザーが 3 ドットの詳細メニューをクリックしても、アクションはトリガーされません。

#### レポート

**グループ化名にスラッシュまたはバックスラッシュが含まれる場合、「表示するデータがありません」**

ユーザーがレポート内のグラフを表示し、グラフ上のグループ化をクリックし、そのグループ名に / または \ が含まれていると、開いた詳細にはグループ化の項目が表示されず、「表示するデータがありません」というメッセージが表示されます。

#### タスク

**ユーザーがタスクに割り当てられると、担当業務がリストから消えない**
