...
+ [!DNL Adobe Workfront] {#new-workfront-experience}
   ...
   + [!DNL Adobe Workfront] の現在の問題 {#wf-current}
      + [レポート：レポートでは、ワイルドカード「$$」の代わりにレポート作成者を使用します[!UICONTROL USERID]&quot;](known-issues-workfront/wf-reports-repeat-report-uses-creater-instead-of-wildcard.md)
      + [ドキュメント：MP4 ファイルをアップロードできません](known-issues-workfront/wf-documents-cannot-upload-mp4.md)
      + [統合：を開けません [!DNL Workfront for G Suite]](known-issues-workfront/wf-integrations-error-when-opening-wf-for-gsuite.md)
      + [タスク：サブタスクを追加できません](known-issues-workfront/wf-tasks-cannot-add-subtask.md)
      ...
      + [[!UICONTROL ホーム]：[!UICONTROL ホーム]で問題の割り当てを削除できない](known-issues-workfront/wf-home-cannot-remove-assignment.md)
      + [タイムシート：タイムシートが生成されない](known-issues-workfront/wf-timesheets-timesheet-not-generated.md)
      + [統合： [!DNL Workfront for Jira]  統合の要素にアクセスできない](known-issues-workfront/wf-integrations-pages-are-blank-in-jira-integration.md)
      + [カスタムフォーム：フィールド名にアポストロフィまたは引用符が含まれている場合、計算でフィールドを使用できない](known-issues-workfront/wf-custom-forms-special-character-in-field-name.md)
      ...
      + [アジャイル：反復に追加されたタスクに関する問題](known-issues-workfront/wf-agile-issues-with-tasks-on-iteration.md)
      + [カスタムフォーム：計算フィールドを設定する際にエラーが発生する](known-issues-workfront/wf-custom-forms-error-with-calculated-field.md)
      + [タイムシート：[!UICONTROL 一般時間]に時間を入力できない](known-issues-workfront/wf-timesheets-general-time-disabled.md)
      + [リスト：[!UICONTROL クイックフィルター]でチームを検索しても結果が返されない](known-issues-workfront/wf-lists-no-results-for-teams-in-quick-filter.md)
      + [ナビゲーション：ピン留めを削除した後に、ページをもう一度ピン留めできない](known-issues-workfront/wf-navigation-undo-pin-does-not-replace-pin.md)
      + [割り当て：チームを一括割り当て中にエラーが発生する](known-issues-workfront/wf-assignments-error-when-bulk-assigning-team.md)
      + [タスク：タスクヘッダーに[!UICONTROL 先行タスク]アイコンが表示されない](known-issues-workfront/wf-tasks-predecessor-icon-missing-from-header.md)
      + [プルーフ：プルーフにグループを追加しても、一部のメンバーがグループに追加されない](known-issues-workfront/wf-proofs-group-members-not-added.md)
      + [タスクと問題：タスクまたは問題の、名前またはタスクの完了率を編集できない](known-issues-workfront/wf-tasks-issues-cannot-edit-name-percent.md)
      + [レイアウトテンプレート：レイアウトテンプレートでリストをカスタマイズする際にエラーが発生する](known-issues-workfront/wf-layout-templates-error-lists-users.md)
      + [プルーフ：「新しいプルーフ受信者」テキストボックスが小さすぎる](known-issues-workfront/wf-proof-proof-share-recipient-box-too-small.md)
      ...
      + [タイムシート：[!UICONTROL Tab] キーを使用したときに時間が保存されない](known-issues-workfront/wf-timesheets-hours-do-not-save-when-using-tab.md)
      ...
      + [メール通知：「[!UICONTROL 自分に問題が割り当てられた]」設定が表示される](known-issues-workfront/wf-email-notif-im-assigned-to-issue-displaying.md)
      ...
      + [報告書：ダッシュボードで表示している場合に、報告書を水平にスクロールできない](known-issues-workfront/wf-reports-cannot-scroll-horizontally.md)
      + [[!UICONTROL ホーム]：プロジェクト名が、[!UICONTROL 作業リスト]に GUID として表示される](known-issues-workfront/wf-home-project-name-shows-as-guid.md)
      + [報告書：デフォルトでカレンダーに古い日付が表示される](known-issues-workfront/wf-reports-caledar-defaults-to-old-dates.md)
...
+ [!DNL Adobe Workfront Fusion] {#fusion}
   ...
   + [!DNL Workfront Fusion] の現在の問題 {#fusion-current}
      ...
      + [[!DNL Workfront Fusion]： [!DNL Adobe PDF Services] ／[!UICONTROL テキストを抽出]モジュールでテキストが生成されない](known-issues-workfront-fusion/fusion-pdf-extract-text.md)
