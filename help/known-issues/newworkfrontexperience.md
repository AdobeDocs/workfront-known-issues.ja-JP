...
| **問題** | **最終変更日** |
|----------------------------------| ----------------- |
| [ボード： [!UICONTROL 移動] options](known-issues-workfront/wf-boards-top-of-column-ineffective.md) | 2024年2月6日（PT） |
...
| [リソース管理：担当業務の問題が原因で財務計算が正しくない](known-issues-workfront/wf-resource-mgmt-job-role-rates.md) | 2024年1月25日（PT） |
